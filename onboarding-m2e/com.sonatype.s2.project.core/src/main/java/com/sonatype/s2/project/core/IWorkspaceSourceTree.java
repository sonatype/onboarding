...
public interface IWorkspaceSourceTree
{
    ...
    /**
     * The source tree cannot be accessed due to authorization failure.
     */
    ...
    /**
     * Human readable message associated with the source tree status. Not null for
     * STATUS_NOT_SUPPORTED.
     */
    public String getStatusMessage();

    /**
     * Human readable help message associated with the source tree status. 
     */
