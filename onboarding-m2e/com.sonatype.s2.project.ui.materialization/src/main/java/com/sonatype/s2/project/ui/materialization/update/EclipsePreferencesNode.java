...
public class EclipsePreferencesNode
    extends CodebaseViewNode
{
    public EclipsePreferencesNode( IWorkspaceCodebase workspaceCodebase )
    {
        super( workspaceCodebase, Messages.eclipsePreferencesNode_title, null, Images.ECLIPSE_PREFERENCES );
    }
}
