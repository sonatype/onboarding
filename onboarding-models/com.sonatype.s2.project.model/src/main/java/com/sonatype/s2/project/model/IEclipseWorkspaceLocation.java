...
public interface IEclipseWorkspaceLocation
{

    /**
     * Gets the directory to the local Eclipse workspace.
     * 
     * @return The directory to the local Eclipse workspace or {@code null} if not set.
     */
