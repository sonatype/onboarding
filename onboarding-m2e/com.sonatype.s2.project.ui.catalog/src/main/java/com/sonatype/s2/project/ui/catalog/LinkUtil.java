...
public class LinkUtil
{
    ...
    public static void openLink( Object urlObject, boolean internal )
    {
        ...
        try
        {
            IWorkbenchBrowserSupport support = PlatformUI.getWorkbench().getBrowserSupport();
            IWebBrowser browser =
                internal && support.isInternalWebBrowserAvailable() ? support.createBrowser(
        ...
        {
            Dialog.openCoreError( null, Messages.linkUtil_errors_errorOpeningUrl, partInitException );
        }
        catch ( MalformedURLException malformedURLException )
        {
            Dialog.openError( null, Messages.linkUtil_errors_invalidUrl, malformedURLException.getMessage() );
        }
    }
