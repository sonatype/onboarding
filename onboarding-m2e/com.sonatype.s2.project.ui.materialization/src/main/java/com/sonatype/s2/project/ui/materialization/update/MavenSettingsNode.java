...
public class MavenSettingsNode
    extends CodebaseViewNode
{
    public MavenSettingsNode( IWorkspaceCodebase workspaceCodebase )
    {
        super( workspaceCodebase, Messages.mavenSettingsNode_title, null, Images.MAVEN_SETTINGS );
    }
}
