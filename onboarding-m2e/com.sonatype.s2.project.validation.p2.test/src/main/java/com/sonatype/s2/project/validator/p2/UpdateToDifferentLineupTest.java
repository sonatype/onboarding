...
public class UpdateToDifferentLineupTest
    extends AbstractValidatorTest
{

    public void testUpdateWithDifferentLineupId()
        throws Exception
    {
        ...
        String projectURL =
            new File( "resources/testUpdateWithDifferentLineupId/before/project/beforeCodebaseDescriptor.xml" ).toURI().toURL().toString();
        ...
        p2LineupLocation.setUrl( new File( "resources/testUpdateWithDifferentLineupId/before/p2Lineup" ).toURI().toURL().toString() );
        ...
        File afterLineupFile = new File( "resources/testUpdateWithDifferentLineupId/after/p2Lineup" );
